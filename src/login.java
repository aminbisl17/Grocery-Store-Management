...
class login extends JFrame implements ActionListener{
    ...
    private JLabel icon, text1, text2, text3;
    private JTextField username_input;
    private JPasswordField password_input;

      Font font;    
      Border border;
      Color whiteColor = new Color(255,255,255), blackColor = new Color(0,0,0);
    ...
    login() {
            ...
            buttonCustomiser(submit, blackColor, whiteColor, 125, 250, 100, 33, true, true, false, false, null, this);

            text1 = new JLabel("Emri");
            textCustomiser(text1, 100, 110, 80, 20, blackColor, font);
  ...
  //________________________________________________________
            ...
            panelCustomiser(leftPanel, whiteColor, 400, 100);
         // user input--
